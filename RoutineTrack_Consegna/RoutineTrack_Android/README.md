...
RoutineTrack è un'app Android/Kotlin per il tracciamento personale delle abitudini. Il progetto usa Jetpack Compose, Material 3, Room, Retrofit, WorkManager e un backend Flask collegato a TiDB.
...
- Account/Settings con stato sincronizzazione, ultimo sync, `Sync Now`, `Restore from Cloud` e tema light/dark.
